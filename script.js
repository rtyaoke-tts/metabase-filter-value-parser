...
class MetabaseUrlParamParser {
  ...
  get usage() {
    ...
    return `${this.url.origin}?${this.redirectUrlParamName}={your-redirect-url}&debug={true-or-false}${replaceParamStr}`;
  }
...
const getRedirectUrl = () => {
  ...
  const newUrl = `${redirectUrl.origin}?${currentParams.toString()}`;
...
const appendTestLinkElem = () => {
  ...
  }?redirectUrl=https://google.com&debug=true&label_0=lb0&value_0=a,b,andc&label_1=lb1&value_1=aa,bb,andcc&label_2=lb2&value_2=aa,bb,andcc&hoge=hoge`;
